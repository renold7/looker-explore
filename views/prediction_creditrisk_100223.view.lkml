# The name of this view in Looker is "Prediction Creditrisk 100223"
view: prediction_creditrisk_100223 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `demo_dataset.prediction_creditrisk_100223` ;;
