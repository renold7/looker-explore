# The name of this view in Looker is "San Fransisco Bikeshare Testing"
view: san_fransisco_bikeshare_testing {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `demo_dataset.san_fransisco_bikeshare_testing` ;;
